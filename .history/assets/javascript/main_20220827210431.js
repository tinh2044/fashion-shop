...
function Validator(selector) {
    ...
    const confirmBtn = getSiblingElement(formElement,'.auth-form__controls').querySelector('.btn auth-form__control-back')
    const backBtn = getSiblingElement(formElement,'.auth-form__controls').querySelector('.btn--primary')
